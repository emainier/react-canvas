...
var Surface = React.createClass({
  ...
  handleMouseMove: function (e) {
    // We use the mousemove event on the Surface, but
    // we want children to react  'mouseover' events.
    // By changing the type of the event here we trick the hitTest()
    // into returning target that has a mouseover handler.
    e.type = 'mouseover';
    this.hitTest(e);
  },
